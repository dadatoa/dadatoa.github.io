...
description: "Mon projet commence à grossir tranquillement. L'utilisation de
  ...
  n'ont rien à voir avec mon site Jekyll. En plus Jekyll à tendance à recopier
  tout le contenu du projet vers le dossier de déploiment, et peut-être qu'il y
  a des fichiers qui n'ont pas besoin d'être déployés."
---
